...
function animate(action, frameIndex = 0) {
    ...
    gameFrame++;
    requestAnimationFrame(() => animate(action, frameIndex));
}

animate("idle"); // Change the parameter to a valid animation state from the list below
